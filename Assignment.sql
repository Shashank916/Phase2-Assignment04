...
declare @TotalTax float
exec TotalTaxForCompany 'Redmi', @TotalTax output
print 'Total Tax for Redmi: ' + CONVERT(varchar, @TotalTax)

declare @TotalTax float
exec TotalTaxForCompany 'Realme', @TotalTax output
print 'Total Tax for Realme: ' + CONVERT(varchar, @TotalTax)

declare @TotalTax float
exec TotalTaxForCompany 'Xiaomi', @TotalTax output
print 'Total Tax for Xiaomi: ' + CONVERT(varchar, @TotalTax)

declare @TotalTax float
exec TotalTaxForCompany 'HTC', @TotalTax output
